...
@Component({
  ...
  template: `
    <div class="version-report">
      <h1>Angular 14 - Webpack Browser Builder Test</h1>
      <p>This app tests rules_js + pnpm symlinks + Angular 14's webpack-based browser builder.</p>
...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log('=== rules_js + pnpm + Angular 14 Test Results ===');
