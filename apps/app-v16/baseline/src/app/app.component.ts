...
@Component({
  ...
  template: `
    <div class="version-report">
      <h1>Angular 16 - ESBuild Browser Builder Test</h1>
      <p>This app tests rules_js + pnpm symlinks + Angular 16's browser-esbuild builder.</p>
...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log('=== rules_js + pnpm + Angular 16 Test Results ===');
